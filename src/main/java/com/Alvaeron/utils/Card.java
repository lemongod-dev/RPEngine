...
public class Card {
	...
	public void sendCard(RoleplayPlayer rpp) {
		...
		sendJson(rpp.getPlayer(), "{text:\"" + Lang.CARD_FIELD_NAME.toString() +": \", color:\"green\", extra:[{text:\"" + rpp.getName() + "\",color:\"white\"}],hoverEvent:{action:show_text,value:{text:\"" + Lang.CARD_CLICK_TO_EDIT.toString() + "\",color:\"aqua\"}},clickEvent:{action:\"suggest_command\",value:\"/card name " + rpp.getName() + "\"}}");
